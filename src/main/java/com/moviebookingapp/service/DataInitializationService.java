    ...
    private void initializeMovieData() {
        List<Movie> movies = Arrays.asList(
                ...
                createMovie("Captain America: Brave New World", "ReelCritic IMAX", 245, "NOW SHOWING",
                        ...
                        "Julius Onah",
                        Arrays.asList("Anthony Mackie", "Danny Ramirez", "Shira Haas", "Xosha Roquemore",
                                "Carl Lumbly"),
                ...
                createMovie("Thunderbolts", "INOX", 312, "COMING SOON",
                        ...
                        "Jake Schreier",
                        Arrays.asList("Florence Pugh", "Sebastian Stan", "David Harbour", "Wyatt Russell",
                                "Julia Louis-Dreyfus"),
                ...
                createMovie("Fantastic Four: First Steps", "Cinepolis", 298, "COMING SOON",
                        ...
                        "Matt Shakman",
                        Arrays.asList("Pedro Pascal", "Vanessa Kirby", "Joseph Quinn", "Ebon Moss-Bachrach",
                                "Ralph Ineson"),
                ...
                createMovie("Superman", "PVR Cinemas", 189, "COMING SOON",
                        ...
                        "James Gunn",
                        Arrays.asList("David Corenswet", "Rachel Brosnahan", "Nicholas Hoult", "Edi Gathegi",
                                "Nathan Fillion"),
                ...
                createMovie("Dune: Part Two", "CinemaVerse IMAX", 523, "NOW SHOWING",
                        ...
                        "Denis Villeneuve",
                        Arrays.asList("Timothée Chalamet", "Zendaya", "Rebecca Ferguson", "Josh Brolin",
                                "Austin Butler"),
                ...
                createMovie("Beetlejuice Beetlejuice", "PVR Cinemas", 298, "NOW SHOWING",
                        ...
                        "Tim Burton",
                        Arrays.asList("Michael Keaton", "Winona Ryder", "Catherine O'Hara", "Jenna Ortega",
                                "Willem Dafoe"),
                ...
                createMovie("John Wick: Chapter 4", "PVR Cinemas", 389, "NOW SHOWING",
                        ...
                        "Chad Stahelski",
                        Arrays.asList("Keanu Reeves", "Donnie Yen", "Bill Skarsgård", "Laurence Fishburne",
                                "Hiroyuki Sanada"),
                ...
                createMovie("Avengers: Endgame", "CinemaVerse IMAX", 743, "CLASSIC",
                        ...
                        Arrays.asList("Robert Downey Jr.", "Chris Evans", "Mark Ruffalo", "Chris Hemsworth",
                                "Scarlett Johansson"),
                ...
                createMovie("The Dark Knight", "INOX", 892, "CLASSIC",
                        ...
                        "Christopher Nolan",
                        Arrays.asList("Christian Bale", "Heath Ledger", "Aaron Eckhart", "Michael Caine",
                                "Gary Oldman"),
                ...
                createMovie("Inception", "Cinepolis", 723, "CLASSIC",
                        ...
                        "Christopher Nolan",
                        Arrays.asList("Leonardo DiCaprio", "Marion Cotillard", "Tom Hardy", "Joseph Gordon-Levitt",
                                "Elliot Page"),
