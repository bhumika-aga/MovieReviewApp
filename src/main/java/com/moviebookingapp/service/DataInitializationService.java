...
public class DataInitializationService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            ...
            System.err.println("Warning: Could not connect to MongoDB. Movie data initialization skipped.");
            System.err.println("For full functionality, please ensure MongoDB is running on localhost:27017");
    ...
    private Movie createMovie(String name, String theatre, Integer tickets, String status,
