        ...
        public void run(String... args) throws Exception {
                ...
                try {
                        ...
                        if (movieCount == 0) {
                                ...
                                System.out.println(
                                                "🔄 Clearing existing movie data and reinitializing with updated poster URLs...");
                        ...
                        System.err.println(
                                        "⚠️  Warning: Could not initialize MongoDB data. Using mock service as fallback.");
        ...
        private void initializeMovieData() {
                List<Movie> movies = Arrays.asList(
                                ...
                                createMovie("Captain America: Brave New World", "ReelCritic IMAX", 245, "NOW SHOWING",
                                                ...
                                                "Julius Onah",
                                                Arrays.asList("Anthony Mackie", "Danny Ramirez", "Shira Haas",
                                                                "Xosha Roquemore",
                                                                "Carl Lumbly"),
                                                "Action, Adventure, Sci-Fi", "English", 118, 7.2,
                                                LocalDate.of(2025, 2, 14), "PG-13",
                                ...
                                createMovie("Thunderbolts", "INOX", 312, "COMING SOON",
                                                ...
                                                "Jake Schreier",
                                                Arrays.asList("Florence Pugh", "Sebastian Stan", "David Harbour",
                                                                "Wyatt Russell",
                                                                "Julia Louis-Dreyfus"),
                                                "Action, Adventure, Comedy", "English", 130, 7.5,
                                                LocalDate.of(2025, 5, 2), "PG-13",
                                ...
                                createMovie("Fantastic Four: First Steps", "Cinepolis", 298, "COMING SOON",
                                                ...
                                                "Matt Shakman",
                                                Arrays.asList("Pedro Pascal", "Vanessa Kirby", "Joseph Quinn",
                                                                "Ebon Moss-Bachrach",
                                                                "Ralph Ineson"),
                                                "Action, Adventure, Sci-Fi", "English", 125, 8.0,
                                                LocalDate.of(2025, 7, 25), "PG-13",
                                ...
                                createMovie("Superman", "PVR Cinemas", 189, "COMING SOON",
                                                ...
                                                "James Gunn",
                                                Arrays.asList("David Corenswet", "Rachel Brosnahan", "Nicholas Hoult",
                                                                "Edi Gathegi",
                                                                "Nathan Fillion"),
                                                "Action, Adventure, Drama", "English", 140, 8.5,
                                                LocalDate.of(2025, 7, 11), "PG-13",
                                ...
                                createMovie("Dune: Part Two", "CinemaVerse IMAX", 523, "NOW SHOWING",
                                                ...
                                                Arrays.asList("Timothée Chalamet", "Zendaya", "Rebecca Ferguson",
                                                                "Josh Brolin",
                                                                "Austin Butler"),
                                                "Action, Adventure, Drama", "English", 166, 8.8,
                                                LocalDate.of(2024, 3, 1), "PG-13",
                                ...
                                createMovie("Deadpool & Wolverine", "INOX", 487, "NOW SHOWING",
                                                ...
                                                "Shawn Levy",
                                                Arrays.asList("Ryan Reynolds", "Hugh Jackman", "Emma Corrin",
                                                                "Morena Baccarin", "Rob Delaney"),
                                                "Action, Comedy, Sci-Fi", "English", 128, 8.1,
                                                LocalDate.of(2024, 7, 26), "R",
                                ...
                                createMovie("Inside Out 2", "Cinepolis", 432, "NOW SHOWING",
                                                ...
                                                "Kelsey Mann",
                                                Arrays.asList("Amy Poehler", "Maya Hawke", "Kensington Tallman",
                                                                "Liza Lapira", "Tony Hale"),
                                                "Animation, Family, Comedy", "English", 96, 7.8,
                                                LocalDate.of(2024, 6, 14), "PG",
                                ...
                                createMovie("Beetlejuice Beetlejuice", "PVR Cinemas", 298, "NOW SHOWING",
                                                ...
                                                "Tim Burton",
                                                Arrays.asList("Michael Keaton", "Winona Ryder", "Catherine O'Hara",
                                                                "Jenna Ortega",
                                                                "Willem Dafoe"),
                                                "Comedy, Horror, Fantasy", "English", 104, 7.2,
                                                LocalDate.of(2024, 9, 6), "PG-13",
                                ...
                                createMovie("Oppenheimer", "CinemaVerse IMAX", 612, "NOW SHOWING",
                                                ...
                                                "Christopher Nolan",
                                                Arrays.asList("Cillian Murphy", "Emily Blunt", "Matt Damon",
                                                                "Robert Downey Jr.",
                                                                "Florence Pugh"),
                                                "Biography, Drama, History", "English", 180, 8.4,
                                                LocalDate.of(2023, 7, 21), "R",
                                ...
                                createMovie("Barbie", "INOX", 578, "NOW SHOWING",
                                                ...
                                                "Greta Gerwig",
                                                Arrays.asList("Margot Robbie", "Ryan Gosling", "America Ferrera",
                                                                "Kate McKinnon", "Issa Rae"),
                                                "Adventure, Comedy, Fantasy", "English", 114, 7.0,
                                                LocalDate.of(2023, 7, 21), "PG-13",
                                ...
                                createMovie("Guardians of the Galaxy Vol. 3", "Cinepolis", 456, "NOW SHOWING",
                                                ...
                                                "James Gunn",
                                                Arrays.asList("Chris Pratt", "Zoe Saldana", "Dave Bautista",
                                                                "Karen Gillan", "Pom Klementieff"),
                                                "Action, Adventure, Comedy", "English", 150, 8.0,
                                                LocalDate.of(2023, 5, 5), "PG-13",
                                ...
                                createMovie("John Wick: Chapter 4", "PVR Cinemas", 389, "NOW SHOWING",
                                                ...
                                                "Chad Stahelski",
                                                Arrays.asList("Keanu Reeves", "Donnie Yen", "Bill Skarsgård",
                                                                "Laurence Fishburne",
                                                                "Hiroyuki Sanada"),
                                                "Action, Crime, Thriller", "English", 169, 7.7,
                                                LocalDate.of(2023, 3, 24), "R",
                                ...
                                createMovie("Avengers: Endgame", "CinemaVerse IMAX", 743, "CLASSIC",
                                                ...
                                                Arrays.asList("Robert Downey Jr.", "Chris Evans", "Mark Ruffalo",
                                                                "Chris Hemsworth",
                                                                "Scarlett Johansson"),
                                                "Action, Adventure, Drama", "English", 181, 8.4,
                                                LocalDate.of(2019, 4, 26), "PG-13",
                                ...
                                createMovie("The Dark Knight", "INOX", 892, "CLASSIC",
                                                ...
                                                Arrays.asList("Christian Bale", "Heath Ledger", "Aaron Eckhart",
                                                                "Michael Caine",
                                                                "Gary Oldman"),
                                                "Action, Crime, Drama", "English", 152, 9.0, LocalDate.of(2008, 7, 18),
                                                "PG-13",
                                ...
                                createMovie("Inception", "Cinepolis", 723, "CLASSIC",
                                                ...
                                                Arrays.asList("Leonardo DiCaprio", "Marion Cotillard", "Tom Hardy",
                                                                ...
                                                                "Elliot Page"),
                                                "Action, Sci-Fi, Thriller", "English", 148, 8.8,
                                                LocalDate.of(2010, 7, 16), "PG-13",
                                ...
                                createMovie("Parasite", "PVR Cinemas", 654, "CLASSIC",
                                                ...
                                                "Bong Joon Ho",
                                                Arrays.asList("Kang-ho Song", "Sun-kyun Lee", "Yeo-jeong Jo",
                                                                "Woo-sik Choi", "So-dam Park"),
                                                "Comedy, Drama, Thriller", "Korean", 132, 8.5,
                                                LocalDate.of(2019, 5, 30), "R",
